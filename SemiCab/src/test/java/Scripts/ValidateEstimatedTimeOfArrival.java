...
public class ValidateEstimatedTimeOfArrival extends Base{
	...
	public void ValidateEstimatedArrival() throws Throwable {
			...
			cu.waitTillElementToBeClickable(driver, l.getEstimatedTimeOfArrival());
			...
			vt[0]=vt[0].replaceAll("th", "").replaceAll("2nd", "02").replaceAll("1st", "01").replaceAll("3rd", "03").replaceAll(" ", "-").replaceAll("Estimated-Time-of-Arrival", "");
			vt[0]=vt[0].replace("\n", "");
